...
from axiomhive_ace_flask import app as application  # WSGI export
...
if not application.config.get('SECRET_KEY'):
    application.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'axiomhive-ace-4d-nexus-2025')

print("AxiomHive 4D ACE WSGI initialized (t=2025-09-20)", file=sys.stderr)
