...
@app.route('/ace-4d', methods=['POST'])
def ace_4d():
    """
    Main 4D ACE endpoint for proactive decomposition and causal graph building
    """
    try:
...
def home():
    ...
    """
    return '''<h1>AxiomHive 4D ACE Live (t=2025-09-20)</h1>
<p>POST /ace-4d {"command": "invoke ACE 4D"}</p>
<p>Example: curl -X POST https://axiomhive.co/ace-4d -H "Content-Type: application/json" -d '{"command": "plan SF move"}'</p>
<footer>
